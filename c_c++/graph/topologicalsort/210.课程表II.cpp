...
数组prerequisites中prerequisites[i]=[ai,bi]，表示在选修课程ai前必须先选修bi。
例如，想要学习课程0，需要先完成课程1，用一个匹配来表示：[0,1]。
返回为了学完所有课程所安排的学习顺序，可能会有多个正确的顺序，只要返回任意一种就可以了。
如果不可能完成所有课程，返回一个空数组。

示例1：
输入：numCourses = 2, prerequisites = [[1,0]]
输出：[0,1]
解释：总共有2门课程，要学习课程1，需要先完成课程0，因此，正确的课程顺序为[0,1]。

示例2：
输入：numCourses = 4, prerequisites = [[1,0],[2,0],[3,1],[3,2]]
输出：[0,2,1,3]
解释：总共有4门课程，要学习课程3，应该先完成课程1和课程2，
     并且课程1和课程2都应该排在课程0之后。
