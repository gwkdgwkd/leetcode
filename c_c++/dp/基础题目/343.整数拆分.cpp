...
// 剑指Offer14-I剪绳子
// 给一根长度为n的绳子，请把绳子剪成整数长度的m段，m、n都是整数，
// n>1并且m>1，每段绳子的长度记为k[0],k[1]...k[m-1]。
// 请问k[0]*k[1]*...*k[m-1]可能的最大乘积是多少？
// 当绳子长8时，把它剪成长度为2、3、3的三段，此时得到的最大乘积是18。

// 剑指Offer14-II剪绳子II
// 给一根长度为n的绳子，请把绳子剪成整数长度的m段，m、n都是整数，
// n>1并且m>1，每段绳子的长度记为k[0],k[1]...k[m - 1]。
// 请问k[0]*k[1]*...*k[m - 1]可能的最大乘积是多少？
// 当绳子长8时，把它剪成分别为2、3、3的三段，此时得到的最大乘积是18。
