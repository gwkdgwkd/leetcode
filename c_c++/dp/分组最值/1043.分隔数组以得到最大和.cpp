...
输出：84
解释：
因为k=3可以分隔成[1,15,7] [9] [2,5,10]，
结果为[15,15,15,9,10,10,10]，
...
int maxSumAfterPartitioning(int* arr, int arrSize, int k) {
  // dp[i]：数组的前i个数即nums[0,1...i−1]，被切了Y−1刀，
  // 分割成Y个数组，满足每个数组的个数最大值不超过K，
  // 每个数组的值变成最大值，分割后的最大和。
  int dp[arrSize + 1];
