/*
一个下标从0开始的数组的交替和定义为：
偶数下标处元素之和减去奇数下标处元素之和。
比方说，数组[4,2,5,3]的交替和为(4+5)-(2+3)=4。
给你一个数组nums，请你返回nums中任意子序列的最大交替和，
子序列的下标重新从0开始编号。
一个数组的子序列是从原数组中删除一些元素后（也可能一个也不删除），
剩余元素不改变顺序组成的数组。
