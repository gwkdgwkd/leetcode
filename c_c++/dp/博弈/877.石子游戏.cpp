/*
Alice和Bob用几堆石子在做游戏，一共有偶数堆石子，排成一行，
每堆都有正整数颗石子，数目为piles[i]，游戏以谁手中的石子最多来决出胜负。
石子的总数是奇数，所以没有平局，Alice和Bob轮流进行，Alice先开始。
每回合，玩家从行的开始或结束处取走整堆石头，这种情况一直持续到没有更多的石子堆为止，
此时手中石子最多的玩家获胜，假设Alice和Bob都发挥出最佳水平，
...
bool stoneGame(int* piles, int pilesSize) {
  // dp[i][j]表示当剩下的石子堆为[i,j]时，当前玩家与另一个玩家的石子数量之差的最大值
